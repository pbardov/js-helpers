...
module.exports = {
  ...
  getObjectMethodNames(obj) {
    let props = [];
    let mobj = obj;
    do {
      props = props.concat(Object.getOwnPropertyNames(mobj));
      mobj = Object.getPrototypeOf(mobj);
    } while (mobj);
    return new Set(props.sort().filter((prop) => typeof obj[prop] === 'function'));
  }
};
